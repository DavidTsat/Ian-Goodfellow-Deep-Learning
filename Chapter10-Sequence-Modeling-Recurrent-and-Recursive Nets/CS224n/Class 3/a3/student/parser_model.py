...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden_weight = nn.Parameter(torch.zeros(self.embeddings.shape[1]*self.n_features, self.hidden_size))
        xavier_uniform_(self.embed_to_hidden_weight)
        ...
        xavier_uniform_(self.hidden_to_logits_weight)
